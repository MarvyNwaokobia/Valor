...
--
-- That mattered immediately rather than theoretically: anything that joins the
-- catalogue on `on_chain_id` would match 7 of 26 rows against a fresh database and
-- report success. A silent partial, surfacing later as guns that cannot be bought.
--
