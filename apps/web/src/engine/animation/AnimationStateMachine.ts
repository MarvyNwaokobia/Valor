...
const BERSERKER_ANIMS: AnimationMap = {
  ...
  [AnimState.Jump]:        { clip: CLIP_NAMES.jumpDown,      loop: false, speed: 1.0,  fadeIn: 0.08, fadeOut: 0.12, canInterrupt: true },
  [AnimState.JumpAttack]:  { clip: CLIP_NAMES.rollKick,      loop: false, speed: 1.2,  fadeIn: 0.05, fadeOut: 0.15, canInterrupt: false, nextState: AnimState.Idle },
...
const PHANTOM_ANIMS: AnimationMap = {
  ...
  [AnimState.Jump]:        { clip: CLIP_NAMES.jumpDown,       loop: false, speed: 1.1,  fadeIn: 0.07, fadeOut: 0.1,  canInterrupt: true },
  [AnimState.JumpAttack]:  { clip: CLIP_NAMES.rollKick,       loop: false, speed: 1.3,  fadeIn: 0.04, fadeOut: 0.12, canInterrupt: false, nextState: AnimState.Idle },
...
const SENTINEL_ANIMS: AnimationMap = {
  ...
  [AnimState.Jump]:        { clip: CLIP_NAMES.jumpDown,       loop: false, speed: 1.0,  fadeIn: 0.08, fadeOut: 0.12, canInterrupt: true },
  [AnimState.JumpAttack]:  { clip: CLIP_NAMES.roundhouseKick, loop: false, speed: 1.2,  fadeIn: 0.05, fadeOut: 0.15, canInterrupt: false, nextState: AnimState.Idle },
