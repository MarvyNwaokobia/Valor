...
///      immediately and there was no Safe yet. RotateCeloRelay.s.sol parked
///      everything on 0xc6A4… — a wallet whose key had never been in the repo —
///      as the fast move that stopped the bleeding. That left a single EOA owning
///      five contracts and ~150,000 G$, which is one key away from the situation
///      the rotation was cleaning up. This finishes the job.
///
